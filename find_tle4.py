...
def evaluate_cosmos(params):
    i, raan, e_int, argp, M = params
    l1 = "1 22675U 93036A   09041.47291667  .00000140  00000-0  44158-4 0  9997"
    l2 = f"2 22675 {i:8.4f} {raan:8.4f} {int(e_int):07d} {argp:8.4f} {M:8.4f} 13.97828456804518"
    try:
...
res = minimize(evaluate_cosmos, [74.0375, 21.37, 153164, 63.78, 269.33], method='Nelder-Mead', options={'maxiter': 2000})
print(f"Optimal i, RAAN, e_int, ArgP, M: {res.x}")
